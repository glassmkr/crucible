...
AGPL-3.0-only. See [LICENSE](LICENSE); the license history of earlier releases
is recorded in [CHANGELOG.md](CHANGELOG.md). Third-party dependency licenses
are listed in [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md). This
